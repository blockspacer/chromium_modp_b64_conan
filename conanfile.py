...
class chromium_modp_b64_conan_project(conan_build_helper.CMakePackage):
    name = "chromium_modp_b64"
    ...
    description = "modified `modp_b64` library from chromium"
    topics = ('c++')
    ...
    def package_info(self):
        #self.cpp_info.libs = ["chromium_modp_b64"]
        ...
        #  os.path.join("base", "third_party", "modp_b64"))
        #self.cpp_info.includedirs.append(
        #  os.path.join("base", "third_party", "modp_b64", "compat"))
